class DataPrivacyText {
  ...
  final info = [
    ...
    [
      ...
      'You can update or delete your personal information at any time by contacting us at [insert contact information]. You can also opt-out of receiving promotional emails or newsletters by following the instructions in the email. You have the right to access, correct, or delete your personal information under applicable data protection laws.'
    ],
    [
    ...
    [
      'Contact Us',
      'If you have any questions or concerns about this Data and Privacy Statements, Contact us at leroyroentgen@gmail.com'
    ]
  ];
}
